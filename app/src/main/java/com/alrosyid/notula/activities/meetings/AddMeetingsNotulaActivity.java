...
public class AddMeetingsNotulaActivity extends AppCompatActivity  {
...
//                String myFormat = "dd MMMM yyyy";
        ...
        txtDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(AddMeetingsNotulaActivity.this, date,
...
//Time Picker
        ...
        txtStartTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(AddMeetingsNotulaActivity.this, new TimePickerDialog.OnTimeSetListener() {
...
//                    Intent restart = new Intent(AddMeetingsNotulaActivity.this, AddNotulasHomeActivity.class);
//                    startActivity(restart);

                    Intent i = new Intent(AddMeetingsNotulaActivity.this, DetailMeetingsActivity.class);
...
//                map.put("position",txtName.getText().toString().trim());
        ...
        RequestQueue queue = Volley.newRequestQueue(AddMeetingsNotulaActivity.this);
        queue.add(request);
