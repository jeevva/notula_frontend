...
import com.alrosyid.notula.activities.meetings.AddMeetingsNotulaOnlyActivity;
...
//    private TextView txtTitles;
    ...
    private void init() {
        ...
        txtItemId.setOnClickListener(v -> {
            ...
            Intent i = new Intent(AddNotulasOnlyActivity.this, AddMeetingsNotulaOnlyActivity.class);
