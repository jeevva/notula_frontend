...
public class AddMeetingsNotulaOnlyActivity extends AppCompatActivity  {
...
//                String myFormat = "dd MMMM yyyy";
        ...
        txtDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(AddMeetingsNotulaOnlyActivity.this, date,
...
//Time Picker
        ...
        txtStartTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(AddMeetingsNotulaOnlyActivity.this, new TimePickerDialog.OnTimeSetListener() {
...
//                    Intent restart = new Intent(AddMeetingsNotulaOnlyActivity.this, DetailMeetingsActivity.class);
//                    startActivity(restart);
                    Intent i = new Intent(AddMeetingsNotulaOnlyActivity.this, DetailMeetingsActivity.class);
...
//                map.put("position",txtName.getText().toString().trim());
        ...
        RequestQueue queue = Volley.newRequestQueue(AddMeetingsNotulaOnlyActivity.this);
        queue.add(request);
